...
CREATE TABLE `bid` (
  ...
  CONSTRAINT `fk_status_id` FOREIGN KEY (`status`) REFERENCES `bid_status` (`status_id`)
...
CREATE TABLE `bid_result` (
  ...
  `bid_id` int NOT NULL,
  `total_count_bidding` int NOT NULL DEFAULT '0',
  `highest bid` int NOT NULL DEFAULT '0',
...
CREATE TABLE `users` (
  ...
  `verification_id` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `users` VALUES (1,1,1,'admin','arioamri@gmail.com','admin123',NULL,NULL,0),(2,2,1,'arioamri','arioamri@yahoo.co.id','ca2c8a0b0baccd44a7078af6ef2fe3aa24a2a3e8769031957832149bee3c522c','Banjar Wijaya',55751409,0);
...
CREATE TABLE `verification` (
  ...
  `verification_status` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
-- Dump completed on 2020-04-27 14:30:47
