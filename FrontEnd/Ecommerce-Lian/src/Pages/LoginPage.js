...
import { Login, LoginContoh } from '../Redux/Action';
            ...
            <div className='d-flex justify-content-center' style={{height : '100vh', alignItems : 'center'}}>
                <Form style={{width : '400px', height: '400px'}}>
                    ...
                    <div style={{display: 'flex', justifyContent: 'space-around'}}>
                        ...
                        <Button onClick={this.props.LoginContoh}>
                            Click Me Thunk
                        </Button>
                    </div>
                </Form>
...
const mapStateToProps = (state) => {
    return{
        ...
        boolean : state.trx.boolean
    }
}
 
export default connect(mapStateToProps, { Login, LoginContoh } )(LoginPage);